        ...
        <div style={{ width: openSidebar ? "20%" : "auto" }} className="">
            ...
            <div className={` sidebar-container`} style={{ backgroundColor: "#242B5E" }} >
                <div className={`logo-container m-0 d-flex flex-row-reverse justify-content-between align-items-center`} >
                    ...
                    <div className="ms-4">
                        {openSidebar && <Link className="" to="/dashboardDirecteur"><img src={centreLogo} className="logo"></img></Link>}
                    </div>
                </div>

                <div className="Sidebar h-100 fs-6">
                    <Nav className="flex-column" defaultActiveKey="/dashboardDirecteur" >
                        <Nav.Item><NavLink className="a nav-link link-light" to="/dashboardDirecteur"><img src={dashboard} />{openSidebar && "Dashboard"}</NavLink></Nav.Item>
                        ...
                        <Nav.Item><NavLink className="a nav-link link-light" to="/class"><img src={groupes} />{openSidebar && "Groupe"}</NavLink></Nav.Item>
